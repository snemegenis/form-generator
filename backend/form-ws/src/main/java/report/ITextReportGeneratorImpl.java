        ...
        try (ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream()) {
            ...
            try {
                ...
                try {
                    ...
                    footerTable.addCell(
                            getCell(getBundleMessage("explanation.1"), fontSmaller, Element.ALIGN_JUSTIFIED, 6,
                                    Rectangle.TOP, 1, 2));
                    footerTable.addCell(
                            getCell(getBundleMessage("explanation.2"), fontSmaller, Element.ALIGN_JUSTIFIED, 6,
                    ...
                    headerTable.addCell(getCell(getBundleMessage("header"), fontSmall, Element.ALIGN_RIGHT, 10,
                    ...
                    dateAndNbrTable.addCell(
                            getCell(getBundleMessage("date"), fontNormal, Element.ALIGN_RIGHT, 8, Rectangle.NO_BORDER,
                                    1, 5));
                    dateAndNbrTable.addCell(
                            getCell(printDate ? reportDate.format(ReportConstants.DATE_FORMAT) : "", fontNormal,
                                    Element.ALIGN_CENTER, 8, Rectangle.BOX, 1, 5));
                    dateAndNbrTable.addCell(
                            getCell(getBundleMessage("nbr"), fontNormal, Element.ALIGN_RIGHT, 8, Rectangle.NO_BORDER,
                                    1, 5));
                    dateAndNbrTable.addCell(
                    ...
                    nameAndBirthDateTable.addCell(
                            getCell(patient.getFirstName() + ", " + patient.getLastName(), fontNormal,
                                    Element.ALIGN_CENTER, 8, Rectangle.BOX, 1, 5));
                    for (int i = 0; i < 11; i++) {
                        nameAndBirthDateTable.addCell(
                                getCell(patient.getPersonalId().substring(0 + i, 1 + i), fontNormal,
                                        Element.ALIGN_CENTER, 7, Rectangle.BOX, 1, 5));
                    }
                    nameAndBirthDateTable.addCell(
                            getCell(getBundleMessage("age"), fontNormalBold, Element.ALIGN_RIGHT, 7, Rectangle.BOX, 1,
                                    5));
                    ...
                    for (int i = 0; i < 3; i++) {
                        nameAndBirthDateTable.addCell(
                                getCell(years.substring(0 + i, 1 + i), fontNormal, Element.ALIGN_CENTER, 7,
                                        Rectangle.BOX, 1, 5));
                    }
                    nameAndBirthDateTable.addCell(
                            getCell(getBundleMessage("years"), fontNormal, Element.ALIGN_CENTER, 7, Rectangle.BOX, 3,
                                    5));
                    for (int i = 0; i < 2; i++) {
                        nameAndBirthDateTable.addCell(
                                getCell(months.substring(0 + i, 1 + i), fontNormal, Element.ALIGN_CENTER, 7,
                                        Rectangle.BOX, 1, 5));
                    }
                    nameAndBirthDateTable.addCell(
                            getCell(getBundleMessage("months"), fontNormal, Element.ALIGN_CENTER, 7, Rectangle.BOX, 3,
                                    5));
                    ...
                    Chunk mobilePhone = new Chunk(getMessageOrEmpty(patient.getMobilePhone()),
                            fontNormalUnderLine);
                    ...
                    cellTreatmentImg.addElement(
                            treatments.contains(Treatment.AMBULATORIC) ? checkedImage : uncheckedImage);
                    ...
                    cellTreatmentImg.addElement(
                            treatments.contains(Treatment.MEDICAMENTS) ? checkedImage : uncheckedImage);
                    treatmentTable.addCell(cellTreatmentImg);
                    treatmentTable.addCell(
                    ...
                    cellTreatmentImg = getPdfPCell(Rectangle.NO_BORDER, 1, 5);
                    cellTreatmentImg.addElement(
                            treatments.contains(Treatment.STATIONARY) ? checkedImage : uncheckedImage);
                    treatmentTable.addCell(cellTreatmentImg);
                    treatmentTable.addCell(
                    ...
                    if (treatments.contains(Treatment.OTHER)) {
                        ...
                        paragraphTreatmentOther.add(
                                new Chunk(disabilityReport.getOtherTreatment(), fontNormalUnderLine));
                    }
                    ...
                    Paragraph paragraphTreatmentHistory = new Paragraph(disabilityReport.getTreatmentHistory(),
                            fontNormal);
                    ...
                    if (!appointments.isEmpty()) {
                        ...
                        appointmentsTable.addCell(
                                getCell(getBundleMessage("appointments.details"), fontNormalBold, Element.ALIGN_CENTER,
                        ...
                        for (Appointment appointment : appointments) {
                            appointmentCell = getCell(appointment.getDate().format(ReportConstants.DATE_FORMAT),
                                    fontNormal, Element.ALIGN_CENTER, 12, Rectangle.BOX, 1, 5);
                            appointmentCell.setPaddingTop(0);
                            appointmentsTable.addCell(appointmentCell);

                            appointmentCell = getCell(appointment.getDoctorType(), fontNormal, Element.ALIGN_JUSTIFIED,
                                    12, Rectangle.BOX, 1, 5);
                            appointmentCell.setPaddingTop(0);
                            appointmentsTable.addCell(appointmentCell);

                            appointmentCell = getCell(appointment.getObservation(), fontNormal, Element.ALIGN_JUSTIFIED,
                                    12, Rectangle.BOX, 1, 5);
                            appointmentCell.setPaddingTop(0);
                            appointmentsTable.addCell(appointmentCell);
                    ...
                    barthelIndexTable.addCell(
                            getCell("", fontNormal, Element.ALIGN_CENTER, 8, Rectangle.NO_BORDER, 1, 5));

                    barthelIndexTable.addCell(getCell(disabilityReport.getBarthelIndex() == null ?
                                    "-" :
                                    String.valueOf(disabilityReport.getBarthelIndex()), fontNormal, Element
                                    .ALIGN_CENTER, 8,
                            Rectangle.BOX, 1, 5));
                    ...
                    barthelIndexTable.addCell(
                            getCell("", fontNormal, Element.ALIGN_LEFT, 8, Rectangle.NO_BORDER, 1, 5));
                    document.add(barthelIndexTable);

                    // Temporary disability
                    Paragraph paragraphTemporaryDisabilityLabel = new Paragraph(
                            getBundleMessage("temporary.disability"), fontNormal);
                    ...
                    if (otherDiagnosisList != null && !otherDiagnosisList.isEmpty()) {
                        ...
                        for (int i = 0; i < otherDiagnosisList.size(); i++) {
                            ...
                            paragraphOtherDiagnosisMainLine.add(
                                    new Chunk(getBundleMessage("diagnosis.code"), fontNormal));
                            paragraphOtherDiagnosisMainLine.add(new Chunk(" ", fontNormal));
                            paragraphOtherDiagnosisMainLine.add(
                                    new Chunk(otherDiagnosis.getCode(), fontNormalUnderLine));
                            paragraphOtherDiagnosisMainLine.add(new Chunk(" ", fontNormal));
                            paragraphOtherDiagnosisMainLine.add(
                                    new Chunk(getBundleMessage("diagnosis.text"), fontNormal));
                            paragraphOtherDiagnosisMainLine.add(new Chunk(" ", fontNormal));
                            paragraphOtherDiagnosisMainLine.add(
                                    new Chunk(otherDiagnosis.getText(), fontNormalUnderLine));
                            ...
                            if (otherDiagnosis.getDetails() != null) {
                                ...
                                Paragraph paragraphOtherDiagnosisThirdLine = new Paragraph(16,
                                        otherDiagnosisDetailsChunk);
                    ...
                    Paragraph paragraphDisabilityTypes = new Paragraph(13, getBundleMessage("disablity.types"),
                            fontNormal);
                    ...
                    disabilityTypesTable.addCell(cellDisabilityTypeImg);
                    disabilityTypesTable.addCell(
                            getCell(getBundleMessage("disability.type.disability.level"), fontNormal,
                                    Element.ALIGN_LEFT, 12, Rectangle.NO_BORDER, 1, 3));
                    ...
                    cellDisabilityTypeImg = getPdfPCell(Rectangle.NO_BORDER, 1, 5);
                    cellDisabilityTypeImg.addElement(disabilityTypes.contains(DisabilityType.SPECIAL_REQUIREMENT) ?
                            checkedImage :
                            uncheckedImage);
                    disabilityTypesTable.addCell(cellDisabilityTypeImg);
                    disabilityTypesTable.addCell(
                            getCell(getBundleMessage("disability.type.special.requirement"), fontNormal,
                                    Element.ALIGN_LEFT, 12, Rectangle.NO_BORDER, 1, 3));

                    cellDisabilityTypeImg = getPdfPCell(Rectangle.NO_BORDER, 1, 5);
                    cellDisabilityTypeImg.addElement(disabilityTypes.contains(DisabilityType.HEALTH_COND_CHANGED) ?
                            checkedImage :
                            uncheckedImage);
                    disabilityTypesTable.addCell(cellDisabilityTypeImg);
                    disabilityTypesTable.addCell(
                            getCell(getBundleMessage("disability.type.condition.changed"), fontNormal,
                                    Element.ALIGN_LEFT, 12, Rectangle.NO_BORDER, 1, 3));

                    cellDisabilityTypeImg = getPdfPCell(Rectangle.NO_BORDER, 1, 5);
                    cellDisabilityTypeImg.addElement(disabilityTypes.contains(DisabilityType.REQUIRED_BY_PERSON) ?
                            checkedImage :
                            uncheckedImage);
                    disabilityTypesTable.addCell(cellDisabilityTypeImg);
                    disabilityTypesTable.addCell(
                            getCell(getBundleMessage("disability.type.required.by.person"), fontNormal,
                                    Element.ALIGN_LEFT, 12, Rectangle.NO_BORDER, 3, 3));
                    ...
                    Doctor user = CommonHelper.valueOrDefault((Doctor) parameters.get(ReportConstants.PARAM_USER),
                            null);
                    signatureTable.addCell(
                            getCell("", fontNormal, Element.ALIGN_CENTER, 12, Rectangle.NO_BORDER, 1, 3));
                    signatureTable.addCell(
                            getCell(user.getFirstName() + " " + user.getLastName(), fontNormal, Element.ALIGN_CENTER,
                    ...
                    signatureTable.addCell(
                            getCell("", fontNormal, Element.ALIGN_CENTER, 12, Rectangle.NO_BORDER, 1, 3));
                    signatureTable.addCell(
                            getCell(user.getOccupation(), fontNormal, Element.ALIGN_CENTER, 12, Rectangle.NO_BORDER, 1,
                                    3));
                    signatureTable.addCell(
                            getCell("", fontNormal, Element.ALIGN_CENTER, 12, Rectangle.NO_BORDER, 1, 3));
                    signatureTable.addCell(
                    ...
                    PdfPCell signatureCell = getCell(getBundleMessage("doctor.full.name"), fontSmall,
                            Element.ALIGN_CENTER, 6, Rectangle.NO_BORDER, 1, 3);
