...
public class ITextReportGeneratorImpl implements ReportGenerator {
    ...
    private byte[] buildDisabilityReport(DisabilityReport disabilityReport, Map<String, Object> parameters)
        ...
        footerTable.addCell(
                getCell(bundle.getString("explanation.1"), fontSmaller, Element.ALIGN_JUSTIFIED, 6, Rectangle.TOP, 1,
                        2));
        footerTable.addCell(
                getCell(bundle.getString("explanation.2"), fontSmaller, Element.ALIGN_JUSTIFIED, 6, Rectangle.NO_BORDER,
                        1, 2));
        ...
        headerTable.addCell(
                getCell(bundle.getString("header"), fontSmall, Element.ALIGN_RIGHT, 10, Rectangle.NO_BORDER, 1, 0));
        ...
        // Date and number
        LocalDate reportDate = CommonHelper.valueOrDefault((LocalDate) parameters.get(ReportConstants.PARAM_DATE),
                LocalDate.now());
        boolean printDate = CommonHelper.valueOrDefault((Boolean) parameters.get(ReportConstants.PARAM_PRINT_DATE),
                false);
        int reportNbr = CommonHelper.valueOrDefault((Integer) parameters.get(ReportConstants.PARAM_NBR), 0);
        boolean printNbr = CommonHelper.valueOrDefault((Boolean) parameters.get(ReportConstants.PARAM_PRINT_NBR),
                false);
        ...
        dateAndNbrTable.addCell(
                getCell(bundle.getString("date"), fontNormal, Element.ALIGN_RIGHT, 8, Rectangle.NO_BORDER, 1, 5));
        dateAndNbrTable.addCell(getCell(printDate ? reportDate.format(ReportConstants.DATE_FORMAT) : "", fontNormal,
                Element.ALIGN_CENTER, 8, Rectangle.BOX, 1, 5));
        dateAndNbrTable.addCell(
                getCell(bundle.getString("nbr"), fontNormal, Element.ALIGN_RIGHT, 8, Rectangle.NO_BORDER, 1, 5));
        dateAndNbrTable.addCell(
                getCell(printNbr ? String.valueOf(reportNbr) : "", fontNormal, Element.ALIGN_CENTER, 8, Rectangle.BOX,
                        1, 5));
        ...
        nameAndBirthDateTable.addCell(
                getCell(patient.getFirstName() + ", " + patient.getLastName(), fontNormal, Element.ALIGN_CENTER, 8,
                        Rectangle.BOX, 1, 5));
        for (int i = 0; i < 11; i++) {
            nameAndBirthDateTable.addCell(
                    getCell(patient.getPersonalId().substring(0 + i, 1 + i), fontNormal, Element.ALIGN_CENTER, 7,
                            Rectangle.BOX, 1, 5));
        }
        nameAndBirthDateTable.addCell(
                getCell(bundle.getString("age"), fontNormalBold, Element.ALIGN_RIGHT, 7, Rectangle.BOX, 1, 5));
        ...
        for (int i = 0; i < 3; i++) {
            nameAndBirthDateTable.addCell(
                    getCell(years.substring(0 + i, 1 + i), fontNormal, Element.ALIGN_CENTER, 7, Rectangle.BOX, 1, 5));
        }
        nameAndBirthDateTable.addCell(
                getCell(bundle.getString("years"), fontNormal, Element.ALIGN_CENTER, 7, Rectangle.BOX, 3, 5));
        for (int i = 0; i < 2; i++) {
            nameAndBirthDateTable.addCell(
                    getCell(months.substring(0 + i, 1 + i), fontNormal, Element.ALIGN_CENTER, 7, Rectangle.BOX, 1, 5));
        }
        nameAndBirthDateTable.addCell(
                getCell(bundle.getString("months"), fontNormal, Element.ALIGN_CENTER, 7, Rectangle.BOX, 3, 5));
        ...
        Chunk mobilePhone = new Chunk(StringHelper.valueOrDefault(patient.getMobilePhone(), "-"), fontNormalUnderLine);
        ...
        String employerText =
                patient.getEmployer() == null ? bundle.getString("common.empty.text") : patient.getEmployer();
        ...
        treatmentTable.addCell(getCell(bundle.getString("treatment.ambulatoric"), fontNormal, Element.ALIGN_LEFT, 12,
        ...
        treatmentTable.addCell(cellTreatmentImg);
        treatmentTable.addCell(getCell(bundle.getString("treatment.medicaments"), fontNormal, Element.ALIGN_LEFT, 12,
                Rectangle.NO_BORDER, 1, 3));

        cellTreatmentImg = getPdfPCell(Rectangle.NO_BORDER, 1, 5);
        cellTreatmentImg.addElement(treatments.contains(Treatment.STATIONARY) ? checkedImage : uncheckedImage);
        treatmentTable.addCell(cellTreatmentImg);
        treatmentTable.addCell(getCell(bundle.getString("treatment.stationary"), fontNormal, Element.ALIGN_LEFT, 12,
                Rectangle.NO_BORDER, 1, 3));
        ...
        treatmentTable.addCell(
                getCell(bundle.getString("treatment.surgery"), fontNormal, Element.ALIGN_LEFT, 12, Rectangle.NO_BORDER,
                        1, 3));

        cellTreatmentImg = getPdfPCell(Rectangle.NO_BORDER, 1, 5);
        cellTreatmentImg.addElement(treatments.contains(Treatment.REABILITATION) ? checkedImage : uncheckedImage);
        treatmentTable.addCell(cellTreatmentImg);
        treatmentTable.addCell(getCell(bundle.getString("treatment.reabilitation"), fontNormal, Element.ALIGN_LEFT, 12,
        ...
        if (!appointments.isEmpty()) {
            PdfPCell appointmentCell = getCell(bundle.getString("appointments.date"), fontNormalBold,
                    Element.ALIGN_CENTER, 12, Rectangle.BOX, 1, 5);
            appointmentCell.setPaddingTop(1);
            appointmentsTable.addCell(appointmentCell);
            appointmentCell = getCell(bundle.getString("appointments.occupation"), fontNormalBold, Element.ALIGN_CENTER,
                    12, Rectangle.BOX, 1, 5);
            appointmentCell.setPaddingTop(1);
            appointmentsTable.addCell(appointmentCell);
            appointmentsTable.addCell(
                    getCell(bundle.getString("appointments.details"), fontNormalBold, Element.ALIGN_CENTER, 12,
                            Rectangle.BOX, 1, 5));
            appointmentCell = getCell(bundle.getString("appointments.attachments"), fontNormalBold,
                    Element.ALIGN_CENTER, 12, Rectangle.BOX, 1, 5);
            ...
            for (Appointment appointment : appointments) {
                ...
                appointmentCell = getCell(appointment.getAttachment() == null ? "-" : appointment.getAttachment(),
                        fontNormal, Element.ALIGN_CENTER, 12, Rectangle.BOX, 1, 5);
                appointmentCell.setPaddingTop(0);
                appointmentsTable.addCell(appointmentCell);
        ...
        Paragraph paragraphTemporaryDisabilityLabel = new Paragraph(bundle.getString("temporary.disability"),
                fontNormal);
        ...
        Paragraph paragraphTemporaryDisability = new Paragraph(
                StringHelper.valueOrDefault(disabilityReport.getLatestDisabilityDesc(),
        ...
        if (otherDiagnosisList != null && !otherDiagnosisList.isEmpty()) {
            ...
            for (int i = 0; i < otherDiagnosisList.size(); i++) {
                ...
                paragraphOtherDiagnosisSecondLine.add(
                        new Chunk(bundle.getString("diagnosis.functional.class"), fontNormal));
            ...
            Paragraph paragraphOtherDiagnosisEmptyLabel = new Paragraph(12, bundle.getString("common.empty.text"),
                    fontNormal);
        ...
        cellDisabilityTypeImg.addElement(
                disabilityTypes.contains(DisabilityType.WORKING_CAPACITY_LEVEL) ? checkedImage : uncheckedImage);
        disabilityTypesTable.addCell(cellDisabilityTypeImg);
        disabilityTypesTable.addCell(
                getCell(bundle.getString("disability.type.working.capacity.level"), fontNormal, Element.ALIGN_LEFT, 12,
                        Rectangle.NO_BORDER, 1, 3));
        ...
        disabilityTypesTable.addCell(cellDisabilityTypeImg);
        disabilityTypesTable.addCell(
                getCell(bundle.getString("disability.type.first.time"), fontNormal, Element.ALIGN_LEFT, 12,
                        Rectangle.NO_BORDER, 1, 3));
        ...
        disabilityTypesTable.addCell(cellDisabilityTypeImg);
        disabilityTypesTable.addCell(
                getCell(bundle.getString("disability.type.disability.level"), fontNormal, Element.ALIGN_LEFT, 12,
                        Rectangle.NO_BORDER, 1, 3));
        ...
        disabilityTypesTable.addCell(cellDisabilityTypeImg);
        disabilityTypesTable.addCell(
                getCell(bundle.getString("disability.type.expired"), fontNormal, Element.ALIGN_LEFT, 12,
                        Rectangle.NO_BORDER, 1, 3));
        ...
        disabilityTypesTable.addCell(cellDisabilityTypeImg);
        disabilityTypesTable.addCell(
                getCell(bundle.getString("disability.type.special.requirement"), fontNormal, Element.ALIGN_LEFT, 12,
                        Rectangle.NO_BORDER, 1, 3));
        ...
        disabilityTypesTable.addCell(cellDisabilityTypeImg);
        disabilityTypesTable.addCell(
                getCell(bundle.getString("disability.type.condition.changed"), fontNormal, Element.ALIGN_LEFT, 12,
                        Rectangle.NO_BORDER, 1, 3));
        ...
        disabilityTypesTable.addCell(cellDisabilityTypeImg);
        disabilityTypesTable.addCell(
                getCell(bundle.getString("disability.type.required.by.person"), fontNormal, Element.ALIGN_LEFT, 12,
                        Rectangle.NO_BORDER, 3, 3));
        ...
        PdfPCell signatureCell = getCell(bundle.getString("doctor.full.name"), fontSmall, Element.ALIGN_CENTER, 6,
                Rectangle.NO_BORDER, 1, 3);
        signatureCell.setCellEvent(new DottedCell(Rectangle.TOP));
        signatureTable.addCell(signatureCell);
        signatureTable.addCell(getCell("", fontSmall, Element.ALIGN_CENTER, 6, Rectangle.NO_BORDER, 1, 3));
        signatureCell = getCell(bundle.getString("doctor.code"), fontSmall, Element.ALIGN_CENTER, 6,
                Rectangle.NO_BORDER, 1, 3);
        signatureCell.setCellEvent(new DottedCell(Rectangle.TOP));
        signatureTable.addCell(signatureCell);
        signatureTable.addCell(getCell("", fontSmall, Element.ALIGN_CENTER, 6, Rectangle.NO_BORDER, 1, 3));
        signatureCell = getCell(bundle.getString("doctor.occupation"), fontSmall, Element.ALIGN_CENTER, 6,
                Rectangle.NO_BORDER, 1, 3);
        signatureCell.setCellEvent(new DottedCell(Rectangle.TOP));
        signatureTable.addCell(signatureCell);
        signatureTable.addCell(getCell("", fontSmall, Element.ALIGN_CENTER, 6, Rectangle.NO_BORDER, 1, 3));
        signatureCell = getCell(bundle.getString("doctor.signature"), fontSmall, Element.ALIGN_CENTER, 6,
                Rectangle.NO_BORDER, 1, 3);
        signatureCell.setCellEvent(new DottedCell(Rectangle.TOP));
        signatureTable.addCell(signatureCell);
        signatureTable.addCell(getCell("", fontSmall, Element.ALIGN_CENTER, 6, Rectangle.NO_BORDER, 1, 3));
